...
Every IPO is automatically resolved to its designated SEBI Registrar via [`services/allotmentService.js`](file:///C:/Users/patel/Desktop/FundinIndia/ipo-intelligence-agent/services/allotmentService.js):
...
```bash
cd C:\Users\patel\Desktop\FundinIndia\ipo-intelligence-agent
npm install
```
...
```env
PORT=5050
MONGO_URI=mongodb://127.0.0.1:27017/finvibes_ipo
COMMUNITY_INVITE_LINK=https://chat.whatsapp.com/BUbMjwEPEHjBEkJ22LdxBj
